...
import {
  UpdateVideoBody,
  UpdateVideoParams,
} from "../modules/videos/video.schema";
import { createVideo, findVideo, findVideos } from "../services/video.srvice";
...
export const stremVideoHandler = async (req: Request, res: Response) => {
  const { videoId } = req.params;
